                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } else { ?>                   
                                                            ...
                                                            <?php } ?>
                                                            <?php /*echo MyFunction::buttonTable('Eliminar recurso', url("painel/recurso/destroy", $key_del) , array('class'=>'js-confirm', 'msg-title'=>'Eliminar recurso', 'msg'=>'Está seguro de eliminar este recurso? <br />Recuerda que esta operación no se puede reversar.'), 'danger', 'fa-ban'); */?>  
