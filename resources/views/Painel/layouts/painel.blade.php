...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
    ...
    <link href="{{ asset('assets/painel/plugins/datatables/dataTables.bootstrap.min.css') }}" rel="stylesheet">
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <?php MenuBackend::load(MenuBackend::BACKEND, Auth::user()->perfil_id); ?>
                
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <?php echo MenuBackend::getMenus(); ?>

                        <!-- Notifications: style can be found in dropdown.less -->
                        {{-- <li><a href="#"><i class="fa fa-users text-aqua"></i>Test</a></li>
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#"><i class="fa fa-users text-aqua"></i>Create Users</a></li>
                                <li><a href="#"><i class="fa fa-users text-aqua"></i>Create Roles</a></li>
                                <li><a href="#"><i class="fa fa-users text-aqua"></i>Create Permissions</a></li>
                        ...
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <ul class="menu">
                                        <li><a href="#"><i class="fa fa-users text-aqua"></i>Create Article</a></li>
                                        <li><a href="#"><i class="fa fa-users text-aqua"></i>Create Categori</a></li>
                                        <li><a href="#"><i class="fa fa-users text-aqua"></i>Manage Date</a></li>
                                    </ul>
                                </li>
                                <li class="footer"><a href="#">View all</a></li>
                            </ul>
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="{{ asset('assets/painel/dist/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Support Team
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="{{ asset('assets/painel/dist/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                        ...
                        <p>
                            ...
                            <small>Faculdade Adventista da Bahia. 08-2014</small>
                        </p>
                    </li>
                    <!-- Menu Body -->
                    <li class="user-body">
...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="{{-- {{ route('task.index') }} --}}"><i class="fa fa-circle-o"></i> Listar Tarefas</a></li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="{{-- {{ route('post.index') }} --}}"><i class="fa fa-circle-o"></i> Listar Post</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
        </ul>
    </li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Mexa com responsabilidade</small>
    </h1>
    <ol class="breadcrumb">
